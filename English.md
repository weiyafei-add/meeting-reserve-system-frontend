...
<!--
    ...
    Right now, this information is only exists on my device. But with a bit of luck, it will travel throught time and space to your device, add appear on your device.

    The fact that this works is a marvel of engineering.

    Deep inside of your browser, there are pieces of code that know how to diaplay a paragraph or draw text in italics. These pieces of code are different between different browsers, and even between different versions of same browser.  Drawing to the screen is also done differently on different operating systems.
...
Fishing is my favourite sport. I often fish for hours whitout catching anything, but this does not worry me.
